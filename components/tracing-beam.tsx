...
export const TracingBeam = ({
  ...
  return (
    <div
      ref={ref}
      className={cn("relative mx-auto h-full w-full max-w-6xl z-50  lg:block md:hidden sm:hidden", className)}
    >
        ...
        >
          ...
          <defs>
            <linearGradient
              ...
              y2={beamEnd}
            >
              <stop stopColor="#f43f5e" stopOpacity="0"></stop> {/* rose-500 */}
              <stop stopColor="#f43f5e"></stop>
              <stop offset="0.325" stopColor="#b91c1c"></stop> {/* red-700 */}
              <stop offset="1" stopColor="#7f1d1d" stopOpacity="0"></stop>{" "}
              {/* red-900 */}
            </linearGradient>
          </defs>
        </svg>
